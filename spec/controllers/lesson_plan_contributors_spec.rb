...
describe LessonPlanContributorsController, type: :controller do
  render_views

  let(:teacher){create :teacher}
  let(:lesson_plan_contributor){create :lesson_plan_contributor, teacher: teacher}
